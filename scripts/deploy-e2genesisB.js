...
async function main() {
  ...
  Everdragons2Genesis = await ethers.getContractFactory("Everdragons2GenesisBridged")
  ...
  console.log("Everdragons2GenesisBridged deployed to:", everdragons2Genesis.address);
