...
async function main() {
  ...
  Everdragons2GenesisV2 = await ethers.getContractFactory("Everdragons2GenesisV2Mumbai")
  everdragons2Genesis = await Everdragons2Genesis.deployProxy(Everdragons2Genesis, [])
